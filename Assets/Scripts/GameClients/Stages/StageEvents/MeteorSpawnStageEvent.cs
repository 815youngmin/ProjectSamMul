...
{
    public class MeteorSpawnStageEvent : StageEventBase
    {
        //총 스폰량
        ...
        public MeteorSpawnStageEvent(StageEventStaticData stageEventStaticData) : base(stageEventStaticData)
        {
        ...
        public override void Update(Stage stage, int stageEventTickNumber)
        {
            ...
            this.SpawnMeteor(stage, currentTickSpawnAmount);
        }

        public override void End(Stage stage)
        {
            this.SpawnMeteor(stage, _remainingSpawnAmountForThisEvent);
        }

        private void SpawnMeteor(Stage stage, int amount)
        {
            if (stage.PC == null)
            {
            ...
            for (int i = 0; i < amount; i++)
            {
                ...
                stage.CreateStageMeteorAreaEffectObject(
