...
{
    public class StickySlimeNormalObject : AreaEffectObjectBase
    {
        ...
        private GameObject _backwardShadow;
        ...
        public void AllocateSharedResources(AreaEffectType areaEffectType)
        {
            ...
            switch (areaEffectType)
            {
                case AreaEffectType.StickySlimeNormalObject_Default:
                    {
                        _forwardBodyPath = "Stages/AreaEffects/StickySlime/Basic/Normal/waterIdle.prefab";
                        _turnAnimationPath = "Stages/AreaEffects/StickySlime/Basic/Normal/waterTurn.prefab";
                        _backwardJumpBodyPath = "Stages/AreaEffects/StickySlime/Basic/Normal/waterBackJump.prefab";
                        _backwardLandingBodyPath = "Stages/AreaEffects/StickySlime/Basic/Normal/waterBackLanding.prefab";
                        _floorEffectPath = "Stages/AreaEffects/StickySlime/Basic/Normal/mark.prefab";
                        
                    }
                    break;
                case AreaEffectType.StickySlimeNormalObject_Bongjun:
                    {
                        _forwardBodyPath = "Stages/AreaEffects/StickySlime/Bongjun/Normal/waterIdle.prefab";
                        _turnAnimationPath = "Stages/AreaEffects/StickySlime/Bongjun/Normal/waterTurn.prefab";
                        _backwardJumpBodyPath = "Stages/AreaEffects/StickySlime/Bongjun/Normal/waterBackJump.prefab";
                        _backwardLandingBodyPath = "Stages/AreaEffects/StickySlime/Bongjun/Normal/waterBackLanding.prefab";
                        _floorEffectPath = "Stages/AreaEffects/StickySlime/Bongjun/Normal/mark.prefab";
                        
                    }
                    break;
                default:
                    throw new NotSupportedException($"StickySlimeNormalObject을 사용하는 AreaEffectType이 아닙니다. 현재 AreaEffectType: [{areaEffectType}]");
            }
            ...
            _backwardShadow = new GameObject("Shadow");
            _backwardShadow.transform.SetParent(this.transform, worldPositionStays: false);
            var shadow = _backwardShadow.AddComponent<SpriteRenderer>();
            ...
            shadow.transform.localPosition = new Vector3(0.1f, -0.2f, 0f);
            ...
            )
        {
            ...
            _forwardAnimation.transform.localScale =  objectRadius / 0.25f * Vector2.one;
            _backwardJumpBody.transform.localScale = objectRadius / 0.4f * Vector2.one;
            _backwardLandingBody.transform.localScale = objectRadius / 0.4f * Vector2.one;
            _turnAnimation.transform.localScale = objectRadius / 0.4f * Vector2.one;
            _backwardShadow.transform.localScale = objectRadius / 0.4f * 1.2f * Vector2.one;
            ...
            _backwardShadow.gameObject.SetActive(false);
                ...
                case SlimeState.Turn:
                    {
                        ...
                        if (_stateChangeAt + _turnAnimation.AnimationDuration < now)
                        {
                            ...
                            _backwardLandingBody.gameObject.SetActive(false);
                            _backwardShadow.gameObject.SetActive(true);
                ...
                case SlimeState.BackLanding:
                    {
                        ...
                        if (_stateChangeAt + _backwardLandingAnimation.AnimationDuration < now)
                        {
                            ...
                            UnityGlobal.SpriteAnimations.CreateAndPlaySpriteAnimation(_floorEffectPath, this.transform.position, this.transform.localScale * 0.8f, null);
                        }
                    }
                    break;
                default:
