...
{
    public class PoisonBall : AreaEffectObjectBase
    {
        private const string BodyPrefabPath = "Stages/AreaEffects/PoisonEffects/PoisonBall.prefab";
        ...
        {
            base.AllocateSharedResourcesForBase(AreaEffectType.PoisonBall);
