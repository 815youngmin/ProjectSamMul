...
{
    public class DrHomingMissileAreaEffectObject : AreaEffectObjectBase
    {
        private static readonly float ExplosionRadius = 2.5f;
        ...
        {
            base.AllocateSharedResourcesForBase(AreaEffectType.DrHomingMissileObject);
            _body = ResourcePool.Instance.InstantiateFromResource("Stages/Projectiles/MissileRadius0_5.prefab");
