...
{
    public class SpinMoveMultiHitObject : SmartAreaEffectObjectBase
    {
        ...
        private static readonly float HittedCharactersClearPeriod = 0.25f;
        private float _hittedCharactersClearNextAt;
        ...
        {
            base.AllocateSharedResourcesForSmartBase(AreaEffectType.SpinMoveMultiHitObject);
            _bodyPath = null;
        }
        ...
        public override void UpdateLogic(Stage stage, float deltaTime)
        {
            ...
            float now = Time.time;
            if (_hittedCharactersClearNextAt <= now)
            {
                _hittedCharacters.Clear();
                _hittedCharactersClearNextAt = now + HittedCharactersClearPeriod;
            }
        ...
        public override void PuttingBackToPool()
        {
            ...
            if (AreaEffectObjectType == AreaEffectType.SpinMoveMultiHitObject)
            {
