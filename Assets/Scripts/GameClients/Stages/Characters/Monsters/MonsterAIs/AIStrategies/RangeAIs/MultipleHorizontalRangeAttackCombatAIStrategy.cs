...
{
    public class MultipleHorizontalRangeAttackCombatAIStrategy : MonsterAIStrategyBase
    {
        // 내가 지금 공격할 대상
        ...
        public MultipleHorizontalRangeAttackCombatAIStrategy(Character target)
        {
            this._target = target;
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            if (_findTargetCheckAt < now)
            {
                ...
                {
                    return enemy ? new MultipleHorizontalRangeAttackCombatAIStrategy(enemy) : new MultipleHorizontalRangeAttackIdleAIStrategy();
                }
            ...
            {
                return new MultipleHorizontalRangeAttackIdleAIStrategy();
            }
