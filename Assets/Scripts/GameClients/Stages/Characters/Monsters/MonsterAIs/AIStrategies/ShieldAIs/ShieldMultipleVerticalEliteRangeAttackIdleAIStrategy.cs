...
{
    public class ShieldMultipleVerticalEliteRangeAttackIdleAIStrategy : MonsterAIStrategyBase
    {
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            if (_findTargetAt < now)
            {
                ...
                if (target != null)
                {
                    return new MultipleVerticalEliteRangeAttackCombatAIStrategy(target);
                }
            }
