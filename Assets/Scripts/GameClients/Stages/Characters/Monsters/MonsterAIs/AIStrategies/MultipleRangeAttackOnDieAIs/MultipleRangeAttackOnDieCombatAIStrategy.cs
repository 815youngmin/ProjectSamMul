...
{
    public class MultipleRangeAttackOnDieCombatAIStrategy : SummonOnDieMonsterAIStrategyBase
    {
        ...
        public MultipleRangeAttackOnDieCombatAIStrategy(Character target) : base()
        {
            _target = target;
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            if(_target == null)
            {
               return new MultipleRangeAttackOnDieIdleAIStrategy();
            }
