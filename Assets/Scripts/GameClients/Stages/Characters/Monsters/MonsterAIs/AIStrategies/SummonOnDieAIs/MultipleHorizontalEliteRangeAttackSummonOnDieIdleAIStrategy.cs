...
{
    public class MultipleHorizontalEliteRangeAttackSummonOnDieIdleAIStrategy : SummonOnDieMonsterAIStrategyBase
    {
        Character _target;
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            {
                return new MultipleHorizontalEliteRangeAttackSummonOnDieCombatAIStrategy(_target);
            }
