...
{
    public class MultipleVerticalEliteRangeAttackSummonOnDieCombatAIStrategy : SummonOnDieMonsterAIStrategyBase
    {
        // 내가 지금 공격할 대상
        ...
        public MultipleVerticalEliteRangeAttackSummonOnDieCombatAIStrategy(Character target)
        {
            _target = target;
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            if (_findTargetCheckAt < now)
            {
                ...
                {
                    return enemy ? new MultipleVerticalEliteRangeAttackSummonOnDieCombatAIStrategy(enemy) : new MultipleVerticalEliteRangeAttackSummonOnDieIdleAIStrategy();
                }
            ...
            {
                return new MultipleVerticalEliteRangeAttackSummonOnDieIdleAIStrategy();
            }
        ...
        public override MonsterAIStrategyBase OnHitted(Stage stage, Monster owner, Character attacker)
        {
            ...
            {
                return new MultipleVerticalEliteRangeAttackSummonOnDieCombatAIStrategy(attacker);
            }
