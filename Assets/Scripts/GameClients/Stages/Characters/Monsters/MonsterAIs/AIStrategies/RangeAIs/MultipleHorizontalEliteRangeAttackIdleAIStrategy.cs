...
{
    public class MultipleHorizontalEliteRangeAttackIdleAIStrategy : MonsterAIStrategyBase
    {
        Character _target;
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            {
                return new MultipleHorizontalEliteRangeAttackCombatAIStrategy(_target);
            }
