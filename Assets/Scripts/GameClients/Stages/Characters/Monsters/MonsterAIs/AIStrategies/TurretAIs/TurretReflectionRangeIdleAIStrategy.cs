...
{
    public class TurretReflectionRangeIdleAIStrategy : MonsterAIStrategyBase
    {
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            if (_findTargetAt < now)
            {
                ...
                {
                    return new TurretReflectionRangeCombatAIStrategy(target);
                }
            }
        ...
        public override MonsterAIStrategyBase OnHitted(Stage stage, Monster owner, Character attacker)
        {
            ...
            // 전투 전략으로 전환 
            return new TurretReflectionRangeCombatAIStrategy(attacker);
        }
    }
}
