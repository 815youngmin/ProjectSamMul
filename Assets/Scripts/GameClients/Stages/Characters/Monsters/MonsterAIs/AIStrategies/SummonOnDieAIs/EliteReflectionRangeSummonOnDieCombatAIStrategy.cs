...
{
    public class EliteReflectionRangeSummonOnDieCombatAIStrategy : SummonOnDieMonsterAIStrategyBase
    { 
        // 내가 지금 공격할 대상
        ...
        public EliteReflectionRangeSummonOnDieCombatAIStrategy(Character target, EliteReflectionRangeAttackAIBlackboard blackboard) 
            : base(blackboard)
        {
            this.target = target;
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            if (_findTargetCheckAt < now)
            {
                ...
                {
                    return enemy ? new EliteReflectionRangeSummonOnDieCombatAIStrategy(enemy, Blackboard) : new EliteReflectionRangeSummonOnDieIdleAIStrategy(Blackboard);
                }
            ...
            {
                return new EliteReflectionRangeSummonOnDieIdleAIStrategy(Blackboard);
            }
        ...
        public override MonsterAIStrategyBase OnHitted(Stage stage, Monster owner, Character attacker)
        {
            ...
            {
                return new EliteReflectionRangeSummonOnDieCombatAIStrategy(attacker, Blackboard);
            }
