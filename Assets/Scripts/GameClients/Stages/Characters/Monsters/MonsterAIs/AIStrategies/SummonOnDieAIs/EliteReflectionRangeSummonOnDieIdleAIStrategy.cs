...
{
    internal class EliteReflectionRangeSummonOnDieIdleAIStrategy : SummonOnDieMonsterAIStrategyBase
    { 
        Character _target;
        ...
        public EliteReflectionRangeSummonOnDieIdleAIStrategy(EliteReflectionRangeAttackAIBlackboard blackboard) : base(blackboard) { }
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            {
                return new EliteReflectionRangeSummonOnDieCombatAIStrategy(_target, Blackboard);
            }
