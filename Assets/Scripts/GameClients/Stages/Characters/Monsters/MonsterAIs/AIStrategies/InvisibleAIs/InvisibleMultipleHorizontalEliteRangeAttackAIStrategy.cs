...
{
    public class InvisibleMultipleHorizontalEliteRangeAttackIdleAIStrategy : BasicIdleAIStrategy
    {
        protected override MonsterAIStrategyBase CombatAIStrategy => new InvisibleMultipleHorizontalEliteRangeAttackCombatAIStrategy();
        protected override float WaitingTime => 2.0f;
    }

    public class InvisibleMultipleHorizontalEliteRangeAttackCombatAIStrategy : MonsterAIStrategyBase
    {
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            {
                return new InvisibleMultipleHorizontalEliteRangeAttackIdleAIStrategy();
            }
