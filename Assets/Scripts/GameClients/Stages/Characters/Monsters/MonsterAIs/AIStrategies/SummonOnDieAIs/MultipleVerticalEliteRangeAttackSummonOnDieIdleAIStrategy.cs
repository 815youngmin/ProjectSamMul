...
{
    public class MultipleVerticalEliteRangeAttackSummonOnDieIdleAIStrategy : SummonOnDieMonsterAIStrategyBase
    {
        Character _target;
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            {
                return new MultipleVerticalEliteRangeAttackSummonOnDieCombatAIStrategy(_target);
            }
