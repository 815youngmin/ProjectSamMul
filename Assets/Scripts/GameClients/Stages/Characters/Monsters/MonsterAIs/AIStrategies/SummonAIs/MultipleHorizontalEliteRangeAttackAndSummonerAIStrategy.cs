...
{
    public class MultipleHorizontalEliteRangeAttackAndSummonerIdleAIStrategy : BasicIdleAIStrategy
    {
        protected override MonsterAIStrategyBase CombatAIStrategy => new MultipleHorizontalEliteRangeAttackAndSummonerCombatAIStrategy();
        protected override float WaitingTime => 2.0f;
    }

    public class MultipleHorizontalEliteRangeAttackAndSummonerCombatAIStrategy : MonsterAIStrategyBase
    {
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            {
                return new MultipleHorizontalEliteRangeAttackAndSummonerIdleAIStrategy();
            }
            ...
            if (_fireAndSummonAt + _fireAndSummonDelay < now)
            {
                ...
                {
                    owner.DoMultipleHorizontalRangeAttackAndMonsterSummonAction(stage, _target,
                        _projectileAmount, _fireAngle, _isRemovableBySpinBladeObject, withIndicator: false,
