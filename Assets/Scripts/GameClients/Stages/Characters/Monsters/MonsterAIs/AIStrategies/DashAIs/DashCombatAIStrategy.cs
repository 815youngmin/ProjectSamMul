...
namespace Z.GameClients.Stages.Characters.Monsters.MonsterAIs.AIStrategies.DashAIs
{
    public class DashCombatAIStrategy : MonsterAIStrategyBase
    {
        ...
        public DashCombatAIStrategy(Character target) : base()
        {
            _target = target;
        }
