...
{
    public class MultipleHorizontalEliteRangeAttackCombatAIStrategy : MonsterAIStrategyBase
    {
        // 내가 지금 공격할 대상
        ...
        public MultipleHorizontalEliteRangeAttackCombatAIStrategy(Character target)
        {
            this._target = target;
        ...
        public override MonsterAIStrategyBase Update(Stage stage, Monster owner)
        {
            ...
            if (_findTargetCheckAt < now)
            {
                ...
                {
                    return enemy ? new MultipleHorizontalEliteRangeAttackCombatAIStrategy(enemy) : new MultipleHorizontalEliteRangeAttackIdleAIStrategy();
                }
            ...
            {
                return new MultipleHorizontalEliteRangeAttackIdleAIStrategy();
            }
        ...
        public override MonsterAIStrategyBase OnHitted(Stage stage, Monster owner, Character attacker)
        {
            ...
            {
                return new MultipleHorizontalEliteRangeAttackCombatAIStrategy(attacker);
            }
