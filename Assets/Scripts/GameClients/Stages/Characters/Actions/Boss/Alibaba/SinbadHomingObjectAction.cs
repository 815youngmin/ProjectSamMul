...
{
    public class SinbadHomingObjectAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private const string HomingProjectilePath = "Stages/AreaEffects/SinbadHomingObject.prefab";
