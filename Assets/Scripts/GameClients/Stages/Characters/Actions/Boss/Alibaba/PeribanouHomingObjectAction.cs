...
{
    public class PeribanouHomingObjectAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private const string HomingProjectilePath = "Stages/AreaEffects/PeribanouHomingObject.prefab";
