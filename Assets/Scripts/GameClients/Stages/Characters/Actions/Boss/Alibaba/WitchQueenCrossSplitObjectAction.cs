...
{
    public class WitchQueenCrossSplitObjectAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        public override void Begin(Stage stage, float now)
        {
            ...
            {
                this.TryCrossFiring(stage, _fireBone.GetWorldPosition(_owner.Body.transform));
            });
        }
        ...
        private void TryCrossFiring(Stage stage, Vector2 firePosition)
        {
