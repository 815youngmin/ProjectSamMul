...
{
    public class SinbadSummonAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private static readonly CharacterType SummonCharacterType = CharacterType.Arabian_EliteVeteranWarrior;

        private static readonly float SummonTime = 1.0f;
        private static readonly int SummonAmount = 2;

        private static readonly float SummonHPWeight = 238.22f;
        private static readonly float SummonAttackPowerWeight = 432.55f;
