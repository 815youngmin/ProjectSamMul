...
{
    public class ThomasEdisonSummonAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private static readonly CharacterType SummonCharacterType = CharacterType.Steampunk_EliteClockworkGolem;

        private static readonly float SummonTime = 1.0f;
        private static readonly int SummonAmount = 2;

        private static readonly float SummonHPWeight = 791.34f;
        private static readonly float SummonAttackPowerWeight = 112.6f;
        ...
        public override void Begin(Stage stage, float now)
        {
            ...
            base.AddOneOffSubAction(summonAt, (Stage stage, float deltaTime, float now) =>
            {
                for (int i = 0; i < SummonAmount; ++i)
                {
                    ...
                    commandSender.SendChangeMonsterAIStrategyCommand(stage, new ShieldEliteSummonIdleAIStrategy());
