...
{
    public class AlchemyGuildLeaderSectorProjectileAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private static readonly string ProjectileBodyPath = "Stages/Projectiles/Dark_Radius0_5.prefab";
        private static readonly float ProjectileSpeed = 16f;
