...
{
    public class NicolasFlamelLightningAction : SmartAction<SpineMonsterAnimationController>
    {
        private static readonly string ReadyAnimationName = "SummonExecutionBegin";
        private static readonly string AttackAnimationName = "SummonExecutionRepeat";
