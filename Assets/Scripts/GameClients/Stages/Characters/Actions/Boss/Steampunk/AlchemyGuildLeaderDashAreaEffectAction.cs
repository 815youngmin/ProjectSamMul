...
{
    public class AlchemyGuildLeaderDashAreaEffectAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private static readonly int AreaEffectAmount = 5;
        private static readonly float AreaEffectRadius = 2;
        private static readonly float AreaEffectCreateDistance = 10f;
        ...
        private static readonly float AreaEffectCreateAt = 0.5f;
        ...
        public override void Begin(Stage stage, float now)
        {
            ...
            float areaEffectAt = dashAt + AreaEffectCreateAt;
            ...
            base.AddOneOffSubAction(areaEffectAt, (Stage stage, float deltaTime, float now) =>
            {
        ...
        private void CreateAreaEffect(Stage stage)
        {
            ...
            {
                Vector2 pos = _owner.CenterPos + Random.insideUnitCircle * AreaEffectCreateDistance;
                stage.CreatePoisonPotion(_owner, _owner.CenterPos, pos, IndicatorDuration, AreaEffectRadius,
                    _owner.SpecialAttackPower * DAMAGE_COEFFICIENT, AreaEffectLifeTime);
            }
        }
    }
}
