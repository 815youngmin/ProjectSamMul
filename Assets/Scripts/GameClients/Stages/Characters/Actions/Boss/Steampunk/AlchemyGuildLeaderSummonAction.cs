...
{
    public class AlchemyGuildLeaderSummonAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private static readonly CharacterType SummonCharacterType = CharacterType.Steampunk_Alchemist;

        private static readonly float SummonTime = 1.0f;
        private static readonly int SummonAmount = 8;

        private static readonly float SummonHPWeight = 280.7f;
        private static readonly float SummonAttackPowerWeight = 135.12f;
        ...
        public override void Begin(Stage stage, float now)
        {
            ...
            base.AddOneOffSubAction(summonAt, (Stage stage, float deltaTime, float now) =>
            {
                for (int i = 0; i < SummonAmount; ++i)
                {
                    ...
                    commandSender.SendChangeMonsterAIStrategyCommand(stage, new PoisonousAreaIdleAIStrategy());
