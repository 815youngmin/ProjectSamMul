...
namespace SamMul.GameClients.Stages.Characters.Actions.Boss.Steampunk
{
    public class WatchManSummonAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private static readonly CharacterType SummonCharacterType = CharacterType.Steampunk_Engineer;

        private static readonly float SummonTime = 1.0f;
        private static readonly int SummonAmount = 5;

        private static readonly float SummonHPWeight = 180.31f;
        ...
        public override void Begin(Stage stage, float now)
        {
            ...
            base.AddOneOffSubAction(summonAt, (Stage stage, float deltaTime, float now) =>
            {
                for (int i = 0; i < SummonAmount; ++i)
                {
                    ...
                    commandSender.SendChangeMonsterAIStrategyCommand(stage, new ShieldRangeIdleAIStrategy());
