...
{
    public class AbandoneSpecimenSpinAreaEffectAction : SmartAction<SpineMonsterAnimationController>
    {
        private static readonly string ReadyAnimationName = "PeriodicExecutionBegin";
        private static readonly string RepeatAnimationName = "PeriodicExecutionRepeat";
        ...
        private static readonly float FireDelay = 0.5f;
        private static readonly int FireAmount = 10;
        private static readonly float CreateRadius = 1f;
        private static readonly float AttackRadius = 0.5f;
        private static readonly float AreaEffectLifeTime = 10f;
        private static readonly float RadiusUpSpeed = 4.0f;
        private static readonly float AngleUpSpeed = 60f;
        ...
        public override void Begin(Stage stage, float now)
        {
            ...
            AnimationController.ContinueAnimation(BodyAnimationTrack.WholeBody, _endAnimation, false, FireDelay * FireCount);
            _currnetFireCount = 0;
                ...
                base.AddOneOffSubAction(time, (Stage stage, float deltaTime, float now) =>
                {
                    ...
                    for (int j = 0; j < FireAmount; j++)
                    {
                        stage.CreateSpinMoveObject(
                            _owner, 
                            AreaEffectType.AbandoneSpecimenSpinAreaEffect,
