...
{
    public class NicolasFlamelSummonAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private static readonly CharacterType SummonCharacterType = CharacterType.Steampunk_EliteSaintGermain;

        private static readonly float SummonTime = 1.0f;
        private static readonly int SummonAmount = 1;

        private static readonly float SummonHPWeight = 300f;
        private static readonly float SummonAttackPowerWeight = 415f;
        ...
        public override void Begin(Stage stage, float now)
        {
            ...
            base.AddOneOffSubAction(summonAt, (Stage stage, float deltaTime, float now) =>
            {
                for (int i = 0; i < SummonAmount; ++i)
                {
                    ...
                    commandSender.SendChangeMonsterAIStrategyCommand(stage, new EliteSummonerIdleAIStrategy());
