...
{
    public class HeadMinerHardSummonAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private static readonly CharacterType SummonCharacterType = CharacterType.Western_ShovelMiner;

        private static readonly float SummonTime = 1.0f;
        private static readonly int SummonAmount = 8;

        private static readonly float SummonHPWeight = 426f;
        private static readonly float SummonAttackPowerWeight = 100.6f;
