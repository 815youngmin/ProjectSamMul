...
{
    public class MiningKingSummonAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private static readonly float SummonLeftTypeHPWeight = 932.4f;
        private static readonly float SummonLeftTypeAttackPowerWeight = 94.7f;
        private static CharacterType SummonLeftCharacterType = CharacterType.Western_EliteGunslingerRider;

        private static readonly float SummonRightTypeHPWeight = 932.4f;
        private static readonly float SummonRightTypeAttackPowerWeight = 94.7f;
        private static CharacterType SummonRightCharacterType = CharacterType.Western_EliteGunslingerRider_B;
        ...
        public override void Begin(Stage stage, float now)
        {
            ...
            base.AddOneOffSubAction(time, (Stage stage, float deltaTime, float now) =>
            {
                var commandSneder1 = stage.SummonMonster(
                    ...
                    SummonDelay);
                commandSneder1.SendChangeMonsterAIStrategyCommand(stage, new MultipleHorizontalEliteRangeAttackCombatAIStrategy(_target));
                ...
                var commandSneder2 = stage.SummonMonster(
                                    ...
                                    SummonDelay);
                commandSneder2.SendChangeMonsterAIStrategyCommand(stage, new MultipleHorizontalEliteRangeAttackCombatAIStrategy(_target));
