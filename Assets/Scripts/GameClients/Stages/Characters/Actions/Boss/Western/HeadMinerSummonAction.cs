...
{
    public class HeadMinerSummonAction : SmartAction<SpineMonsterAnimationController>
    {
        ...
        private static readonly float SummonHPWeight = 399.6f;
        private static readonly float SummonAttackPowerWeight = 94.7f;
